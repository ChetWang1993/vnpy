...
from vnpy.api.okex import OkexSpotApi, OKEX_SPOT_HOST, OkexFutureApi, OKEX_FUTURE_HOST
...
class OkexGateway(VtGateway):
    ...
    def connect(self):
        ...
        self.futureApi.init(apiKey, secretKey, trace, symbols)
    ...
    def qryPosition(self):
        ...
        self.futureApi.futureUserInfo()

    #----------------------------------------------------------------------
    def close(self):
        """关闭"""
        #self.spotApi.close()
        self.futureApi.close()
...
########################################################################
class FutureApi(OkexFutureApi):
    """OKEX的API实现"""

    #----------------------------------------------------------------------
    def __init__(self, gateway):
        """Constructor"""
        super(FutureApi, self).__init__()
    ...
    def subscribe(self, symbol):
        ...
        self.subscribeFutureTicker(symbol)
